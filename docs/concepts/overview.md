...
In practical terms:
- Agent frameworks such as AgentMate remain the **authoring surface**.
- A-PXM is the **compiler/runtime substrate** those frameworks target.
- A-PXM is not a replacement for framework UX; it is the execution layer beneath it.
...
For a detailed analysis of where A-PXM provides concrete value versus alternatives like LangGraph and LLMCompiler, see the [Strategic Analysis](./strategic-analysis.md).
...
3. C. Lattner et al., "MLIR: Scaling Compiler Infrastructure for Domain Specific Computation," in *Proc. CGO '21*, pp. 2–14, IEEE, 2021. DOI: [10.1109/CGO51591.2021.9370308](https://doi.org/10.1109/CGO51591.2021.9370308)

4. G. R. Gao, R. Patel, and T. St. John, "The Codelet Program Execution Model," presented at *WiA, ISCA '13*, Tel-Aviv, Israel, 2013.

5. A. S. Rao and M. P. Georgeff, "BDI Agents: From Theory to Practice," in *Proc. ICMAS '95*, pp. 312–319, AAAI Press, 1995.

6. S. Kim et al., "An LLM Compiler for Parallel Function Calling," in *Proc. ICML '24*, 2024. arXiv: [2312.04511](https://arxiv.org/abs/2312.04511)

7. LangGraph Documentation, LangChain Inc. URL: [https://docs.langchain.com/oss/python/langgraph/](https://docs.langchain.com/oss/python/langgraph/)
